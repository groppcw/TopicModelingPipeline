...
$DIR/../../common/PLDA-base/01-runPLDAinThisJob.sh $SETTINGS_DIR
#python $DIR/../../common/PLDA-base/02-collectModel.py $SETTINGS_DIR
cp $EXPERIMENT_DIRECTORY/partial_results/partial-model $EXPERIMENT_DIRECTORY/local_models/full.model
