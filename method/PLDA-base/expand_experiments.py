      ...
      for alphaVal in alphaList:
        for betaVal in betaList:
          for holdout in holdoutList:
            ...
            if alphaVal != "false": # overwrite the default settings if this value was set
              settingsFile.write('PLDA_ALPHA='+str(alphaVal)+'\n')
            if betaVal != "false":
              settingsFile.write('PLDA_BETA='+str(betaVal)+'\n')
