...
for unused in range(numiters):
  ...
  outfile.write("\n")
  # Commenting this out means that every topic in the first file will
  # be matched to a topic from the second file, but multiple topics from
  # file 1 may be matched to the same topic in file 2.
  topics1.pop(maxFrom)
  #topics2.pop(maxTo)
